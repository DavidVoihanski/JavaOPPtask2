/**
 * just an example for using KML JAK library, will delete it later
 */
...
//
//	/**
//	 * The createPlacemarkWithChart ()-method generates and set a placemark object,
//	 * with the given statistical data . The Icon and Style objects (color and size
//	 * of the text and icon) are saved to the root element. The placemark is created
//	 * and set to the given folder.
//	 * 
