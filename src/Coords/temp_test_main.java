...
public class temp_test_main {
	...
	public static void main(String[] args) {
		Point3D gps1 = new Point3D(32.1226, 30.001, 30);
		Point3D gps2 = new Point3D(32.1282, 30.004, -10);
		MyCoords a = new MyCoords();
		System.out.println(a.vector3D(gps1, gps2));
		System.out.println(a.distance3d(gps1, gps2));
